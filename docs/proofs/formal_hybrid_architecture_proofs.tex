...
\midrule
Architecture & Implemented as a small Dense RetNet-Engram scaffold with optional Block AttnRes, milestone gates, snapshot readout, and TokenCopyBuffer diagnostics. ARC is target design, not yet implemented. \\
